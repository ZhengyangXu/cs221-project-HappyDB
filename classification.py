...
def get_features():
	...
	# X_train_tfidf = tfidf_transformer.fit_transform(X_train_counts) for ignoring length of text and reducing weight of common words, try later?
	return X_train_counts, y_dict_train, X_test_counts, y_dict_test

def main():
	x_train, y_dict_train, x_test, y_dict_test = get_features()
	# run_naive_bayes(x_train, y_dict['gender'], x_test, y_dict_test['gender'])
